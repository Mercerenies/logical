...
clause :: Parser (Clause String Fact)
clause = simpleClause <|> condClause

simpleClause :: Parser (Clause String Fact)
...
-- be a list of facts.
condClause :: Parser (Clause String Fact)
condClause = do
...
parseText :: Op.OpTable -> SymbolTable -> String -> [TokenPos] ->
             Either ParseError ([Clause String Fact], Op.OpTable, SymbolTable)
